...
def cli_menu():
    ...
    print("4. Train PPO+LSTM Agent (Manual)")
    print("5. Run Backtest")
    print("6. Generate HTML Report")
    print("7. Clean Replay Memory")
    print("8. Analyze Replay Memory")
    print("9. Preload Replay Memory from History")
    print("10. Toggle Replay Memory Use [Current: {'ON' if CONFIG['use_memory'] else 'OFF'}]")
    print("11. Optimize PPO+LSTM with Optuna")
    print("12. Optimize Reward Shaping")
    print("13. Exit")
    ...
    while True:
        try:
            ...
            if choice == '1':
                ...
                subprocess.run(["python", "backtest_bot.py"])
            elif choice == '6':
                ...
                subprocess.run(["python", "optimize_reward_shaping.py"])
            elif choice == '13':
                print("Exiting.")
                break
            else:
